// This creates the calandar viewBox
...
// get data from api running on foknet.nl
d3.json("http://api.foknet.nl/due_date", function(error, raw_data) {

    // extracted the data from the api
    var data = []
    ...
    // From flat to nested data structure
    ...
    var dataRects = cals.append("g")
        ...
        .attr("fill", function(d) {
          // Give the right class depending on the value and the given breaks
          // Deciding into which part the go
            if (d.value<breaks[0]) {
                return colours[0];
            }
